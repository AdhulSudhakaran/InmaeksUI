...
import { View,StyleSheet,ScrollView,Text,TouchableHighlight,Image} from "react-native";
            ...
            <View style={styles.container}>
                ...
                <View style={styles.topContainer}>
                    <View style={{flexDirection:'row'}}>
                        <TouchableHighlight style={{height:30,width:30,alignItems:'center',justifyContent:'center',borderColor:'white',borderWidth:1,marginLeft:20,marginTop:20,borderRadius:4}}>
